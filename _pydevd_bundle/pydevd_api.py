...
class PyDevdAPI(object):
    ...
    def setup_auto_reload_watcher(self, py_db, enable_auto_reload, watch_dirs, poll_target_time, ignore_directories, file_extensions):
        py_db.setup_auto_reload_watcher(enable_auto_reload, watch_dirs, poll_target_time, ignore_directories, file_extensions)
